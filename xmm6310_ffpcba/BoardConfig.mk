...
BOARD_WIFI_WAPI := false
#BOARD_WPA_SUPPLICANT_DRIVER := WEXT
USE_BLUEZ := false

# OpenGL drivers config file path
BOARD_EGL_CFG := device/imc/xmm6310_ffpcba/egl.cfg
...
TARGET_RECOVERY_UI_LIB := librecovery_ui_xmm6310_ffpcba
...
# recvoery fstab
recovery_fstab := device/imc/xmm6310_ffpcba/recovery.fstab
